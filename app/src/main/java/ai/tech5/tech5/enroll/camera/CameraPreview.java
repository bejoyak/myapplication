package ai.tech5.tech5.enroll.camera;
...
import ai.tech5.tech5.enroll.exception.ExceptionUtility;
...
public class CameraPreview extends SurfaceView implements SurfaceHolder.Callback {
    ...
    public CameraPreview(Context context, Camera camera, Camera.PreviewCallback cameraPreviewCallBack) {
        ...
        for (Camera.Size str : mSupportedPreviewSizes)
            Logger.addToLog(TAG, "Supported preview sizes" + str.width + "/" + str.height);
        Logger.addToLog(TAG, "*************************************************");
        // supported picture sizes
        mSupportedPictureSizes = mCamera.getParameters().getSupportedPictureSizes();
        for (Camera.Size str : mSupportedPictureSizes) {
            Logger.addToLog(TAG, "\n\n\nSupported Picture sizes" + str.width + "/" + str.height);
        }
        Logger.addToLog(TAG, "*************************************************");
    ...
    public void surfaceChanged(SurfaceHolder holder, int format, int w, int h) {
        ...
        Logger.addToLog(TAG, "surfaceChanged => w=" + w + ", h=" + h);
        ...
        try {
            ...
            Logger.addToLog(TAG, "humanReadableByteCount Optimal Preview size" + mPreviewSize.width + "/" + mPreviewSize.height);
            Logger.addToLog(TAG, "humanReadableByteCount Optimal Picture size" + mPictureSize.width + "/" + mPictureSize.height);
            ...
            ExceptionUtility.logError(TAG, "startCameraPreview", e);
            Logger.addToLog(TAG, "Error starting camera preview: " + e.getMessage());
        }
    }
